...
let ClothesService = class ClothesService {
    ...
    async updateCloth(id, updateClothDto) {
    ...
    async UploadClothProfile(buffer, fileName) {
    }
};
ClothesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(clothe_entity_1.Cloth)),
